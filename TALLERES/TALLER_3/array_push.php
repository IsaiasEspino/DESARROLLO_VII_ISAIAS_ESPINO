...
$misAmigos = ["Carlos", "Roberto", "Juan"]; // Reemplaza esto con tu array de amigos
echo "Mi array origianl de mi lista de amigos: </br>";
print_r($misAmigos);

array_push($misAmigos, "Daniel", "Ruben"); // Reemplaza las comillas vacías con los nombres de tus amigos

echo "</br>Mi lista de amigos despues del array_push:</br>";
print_r($misAmigos);
