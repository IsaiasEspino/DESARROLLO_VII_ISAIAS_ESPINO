...
$misComidas = ["arroz", "porotos", "frijoles"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["lentejas", "carne", "arbejas"]; // Reemplaza con las comidas favoritas de tu amigo
