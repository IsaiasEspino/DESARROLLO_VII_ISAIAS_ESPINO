...
<body>
    ...
    <form action="index.php" method="post">
        ...
        <?php if ($entradaEditar): ?>
            <input type="hidden" name="id" value="<?php echo $entrada->Editar->id; ?>">
        <?php endif; ?>
        
        <div class="mb-3">
            <label for="tipo" class="form-label">Tipo de Entrada</label>
            <select class="form-select" id="tipo" name="tipo" required>
                <option value="1" <?php echo $entrada->Editar && $entrada->Editar->tipo == 1 ? 'selected' : ''; ?>>1 Columna</option>
                <option value="2" <?php echo $entrada->Editar && $entrada->Editar->tipo == 2 ? 'selected' : ''; ?>>2 Columnas</option>
                <option value="3" <?php echo $entrada->Editar && $entrada->Editar->tipo == 3 ? 'selected' : ''; ?>>3 Columnas</option>
            </select>
        </div>
